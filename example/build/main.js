...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_componentsAppJsx2['default'], null), document.getElementById('renderTarget'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesAppStyl = __webpack_require__(159);

	var _stylesAppStyl2 = _interopRequireDefault(_stylesAppStyl);

	// own components

	var _MyModalJsx = __webpack_require__(182);

	var _MyModalJsx2 = _interopRequireDefault(_MyModalJsx);

	console.log(_stylesAppStyl2['default']);
	...
	var App = _reactAddons2['default'].createClass({
	  ...
	  renderModal: function renderModal() {
	    if (this.state.modalOpen) {
	      return _reactAddons2['default'].createElement(_MyModalJsx2['default'], {
	  ...
	  render: function render() {
	    return _reactAddons2['default'].createElement(
	      ...
	      _reactAddons2['default'].createElement(
	        'button',
	        { onClick: this.toggleModal, className: 'Btn' },
	        'Open modal'
	      ),
	      _reactAddons2['default'].createElement(
	        CSSTransitionGroup,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', { style: this.state.styles.overlay }, _react2['default'].createElement('div', { style: this.state.styles.wrapper }, _react2['default'].createElement('div', { style: this.state.styles.subWrapper, onClick: this.onClick, ref: 'overlay' }, _react2['default'].createElement('div', { style: this.state.styles.modal, className: this.props.className, ref: 'modal' }, this.props.children))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(170));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(175));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSimpleModal = __webpack_require__(158);

	var _reactSimpleModal2 = _interopRequireDefault(_reactSimpleModal);

	var MyModal = _react2['default'].createClass({
	  displayName: 'My Modal',
	  propTypes: {
	    toggle: _react2['default'].PropTypes.func.isRequired,
	    modalOpen: _react2['default'].PropTypes.bool
	  },
	  getDefaultProps: function getDefaultProps() {
	    return {
	      modalOpen: false
